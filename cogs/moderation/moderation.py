...
async def do_removal(ctx, limit, predicate, *, before=None, after=None):
    ...
    deleted = len(deleted)
    messages = [f'<:tick:1453391589148983367>> | {deleted} message{" was" if deleted == 1 else "s were"} removed.']
    if deleted:
        messages.append("")
    ...
    if len(to_send) > 2000:
        await ctx.send(f"<:tick:1453391589148983367>> | Successfully removed {deleted} messages.", delete_after=7)
    else:
...
class Moderation(commands.Cog):
  ...
  async def unlockall(self, ctx):
      if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
          button = Button(label="Confirm",
                    ...
                    emoji="<:tick:1453391589148983367>>")
          button1 = Button(label="Cancel",
                     style=discord.ButtonStyle.red,
                     emoji="<:warning:1453394915491975414>")
                  ...
                  if interaction.guild.me.guild_permissions.manage_roles:
                    ...
                    description=f"Unlocking all channels in {ctx.guild.name} .")
                      ...
                      await interaction.channel.send(
                              content=f"<:tick:1453391589148983367>> | Successfully Unlocked {a} Channels")   
                      return
                  else:
                    await interaction.response.edit_message(
                         content=
                           "<:warning:1453394915491975414> | It seems I'm missing the necessary permissions. Please grant me the `manage roles` permissions and try again.",
                              embed=None,
                                  view=None)
              else:
          ...
          embed5 = discord.Embed(title="<:warning:1453394915491975414> Access Denied",
  ...
  async def lockall(self, ctx):
      if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
          ...
          button1 = Button(label="Cancel",
                     style=discord.ButtonStyle.red,
                     emoji="<:cross:1453391695705280705>")
          async def button_callback(interaction: discord.Interaction):
              a = 0
              if interaction.user == ctx.author:
                  if interaction.guild.me.guild_permissions.manage_roles:
                    ...
                    description=f"Locking all channels in {ctx.guild.name}...")
                      ...
                      for channel in interaction.guild.channels:
                          try:
                              ...
                              print(e)
                      await interaction.channel.send(
                              content=f"<:tick:1453391589148983367>>| Successfully locked {a} Channels")
                      return
                  else:
                    await interaction.response.edit_message(
                         content=
          ...
          denied = discord.Embed(title="<:warning:1453394915491975414> Access Denied",
              description="Your role should be above my top role.",
              color=0xFF0000)
  ...
  async def give(self, ctx, member: discord.Member, *, role: discord.Role):
    if not ctx.guild.me.guild_permissions.manage_roles:
        return await ctx.send("<:Denied:1453782238113300666> I don't have permission to manage roles!")
    ...
    if role >= ctx.guild.me.top_role:
        ...
        error.set_author(name="Error", icon_url="https://cdn.discordapp.com/attachments/1305552495942041670/1453759673026084895/GumballZ_Main.jpg?ex=694e9eb3&is=694d4d33&hm=2551fd70aa2d5aca6fc8db65dafab0635fb4b9f7a8166e56450727e8a3d61d32&")
    ...
    if ctx.author != ctx.guild.owner and ctx.author.top_role <= member.top_role:
        ...
        error.set_author(name="Access Denied", icon_url="https://cdn.discordapp.com/attachments/1305552495942041670/1453759673026084895/GumballZ_Main.jpg?ex=694e9eb3&is=694d4d33&hm=2551fd70aa2d5aca6fc8db65dafab0635fb4b9f7a8166e56450727e8a3d61d32&")
        error.set_footer(text=f"Requested by {ctx.author}",
                        icon_url=ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url)
        return await ctx.send(embed=error)
    ...
    try:
        if role not in member.roles:
            ...
            success.set_author(name="Role Added", icon_url="https://cdn.discordapp.com/attachments/1305552495942041670/1453759673026084895/GumballZ_Main.jpg?ex=694e9eb3&is=694d4d33&hm=2551fd70aa2d5aca6fc8db65dafab0635fb4b9f7a8166e56450727e8a3d61d32&")
            ...
            success.set_author(name="Role Removed", icon_url="https://cdn.discordapp.com/attachments/1305552495942041670/1453759673026084895/GumballZ_Main.jpg?ex=694e9eb3&is=694d4d33&hm=2551fd70aa2d5aca6fc8db65dafab0635fb4b9f7a8166e56450727e8a3d61d32&")
            success.set_footer(text=f"Requested by {ctx.author}",
                        icon_url=ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url)
        ...
        error = discord.Embed(
            color=self.color,
            description="<:warning:1453394915491975414> I don't have permission to manage roles for this user!"
        )
        await ctx.send(embed=error)
    except Exception as e:
        error = discord.Embed(
            color=self.color,
            description=f"<:warning:1453394915491975414> An unexpected error occurred: {str(e)}"
        )
        await ctx.send(embed=error)
                    ...
                    description=f"Hiding all channels in {ctx.guild.name} ...")
                      ...
                      for channel in interaction.guild.channels:
                          try:
                              ...
                              print(e)
                      await interaction.channel.send(
                              content=f"<:tick:1453391589148983367>> | Successfully Hidden {a} Channel(s) .")
                      return
                  else:
                    await interaction.response.edit_message(
                         content=
                           "<:warning:1453394915491975414> | It seems I'm missing the necessary permissions. Please grant me the `manage channels` permissions and try again.",
                              embed=None,
                                  view=None)
              else:
                await interaction.response.send_message("Oops! It looks like that message isn't from you. You need to run the command yourself to interact with it.",
                    ...
                    description=f"Unhiding all channels in {ctx.guild.name} .")
                      ...
                      for channel in interaction.guild.channels:
                          try:
                              ...
                              print(e)
                      await interaction.channel.send(
                              content=f"<:tick:1453391589148983367>> | Successfully Unhidden {a} Channel(s) .")
                      return
                  else:
                    await interaction.response.edit_message(
                         content=
  ...
  async def _prefix(self, ctx: commands.Context, prefix: str):
      if not prefix:
          await ctx.reply(embed=discord.Embed(title="<:cross:1453391695705280705> Error",
      ...
      if ctx.author == ctx.guild.owner or ctx.author.top_role.position > ctx.guild.me.top_role.position:
          ...
          embed1=discord.Embed(title="<:tick:1453391589148983367>> Success",
  ...
  async def clone(self, ctx: commands.Context, channel: discord.TextChannel):
    ...
    try:
        ...
        success.set_author(name="Success", icon_url="https://cdn.discordapp.com/attachments/1305552495942041670/1453759673026084895/GumballZ_Main.jpg?ex=694e9eb3&is=694d4d33&hm=2551fd70aa2d5aca6fc8db65dafab0635fb4b9f7a8166e56450727e8a3d61d32&")
        success.set_footer(text=f"Requested by {ctx.author}",
                        icon_url=ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url)
        await ctx.send(embed=success)
    except discord.Forbidden:
  ...
  async def changenickname(self, ctx: commands.Context, member: discord.Member, *, name: str = None):
    ...
    try:
        ...
        if name:
            ...
            success.set_author(name="Nickname Updated", icon_url="https://cdn.discordapp.com/attachments/1305552495942041670/1453759673026084895/GumballZ_Main.jpg?ex=694e9eb3&is=694d4d33&hm=2551fd70aa2d5aca6fc8db65dafab0635fb4b9f7a8166e56450727e8a3d61d32&")
            success.set_footer(text=f"Requested by {ctx.author}",
                        icon_url=ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url)
        else:
            success = discord.Embed(
            ...
            success.set_author(name="Nickname Cleared", icon_url="https://cdn.discordapp.com/attachments/1305552495942041670/1453759673026084895/GumballZ_Main.jpg?ex=694e9eb3&is=694d4d33&hm=2551fd70aa2d5aca6fc8db65dafab0635fb4b9f7a8166e56450727e8a3d61d32&")
            success.set_footer(text=f"Requested by {ctx.author}",
                icon_url=ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url)
        await ctx.send(embed=success)
    except discord.Forbidden:
        error = discord.Embed(
            color=self.color,
            description="<:warning:1453394915491975414> | I don't have permission to manage this user's nickname!"
        )
        await ctx.send(embed=error)
    except Exception as e:
        error = discord.Embed(
            color=self.color,
            description=f"<:warning:1453394915491975414> | An error occurred while trying to change the nickname: {str(e)}"
        )
        await ctx.send(embed=error)
      ...
      if interaction.user == ctx.author:
        if interaction.guild.me.guild_permissions.manage_channels:
          ...
          embed = discord.Embed(
            ...
            color=self.color)
          embed.set_author(name="Channel Nuked", icon_url="https://cdn.discordapp.com/attachments/1305552495942041670/1453759673026084895/GumballZ_Main.jpg?ex=694e9eb3&is=694d4d33&hm=2551fd70aa2d5aca6fc8db65dafab0635fb4b9f7a8166e56450727e8a3d61d32&")
          ...
          await interaction.response.edit_message(
            content=
            "<:warning:1453394915491975414> | It seems I'm missing the necessary permissions. Please grant me the `manage channel` permissions and try again.",
            embed=None,
            view=None)
      else:
        await interaction.response.send_message("Oops! It looks like that message isn't from you. You need to run the command yourself to interact with it.",
  ...
  async def _slowmode(self, ctx: commands.Context, seconds: int = 0):
    if seconds > 120:
      embed=discord.Embed(description="Slowmode can not be over 2 minutes",
                            color=self.color)
      embed.set_author(name="Error", icon_url="https://cdn.discordapp.com/attachments/1305552495942041670/1453759673026084895/GumballZ_Main.jpg?ex=694e9eb3&is=694d4d33&hm=2551fd70aa2d5aca6fc8db65dafab0635fb4b9f7a8166e56450727e8a3d61d32&")
      embed.set_footer(text=f"Requested by {ctx.author}",
                        icon_url=ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url)
    ...
    if seconds == 0:
      ...
      embed=discord.Embed(description="Successfully Set slowmode to **`%s`**" % (seconds),
                            color=self.color)
      embed.set_author(name="Slowmode Activated", icon_url="https://cdn.discordapp.com/attachments/1305552495942041670/1453759673026084895/GumballZ_Main.jpg?ex=694e9eb3&is=694d4d33&hm=2551fd70aa2d5aca6fc8db65dafab0635fb4b9f7a8166e56450727e8a3d61d32&")
      embed.set_footer(text=f"Requested by {ctx.author}",
                        icon_url=ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url)
  ...
  async def _unslowmode(self, ctx: commands.Context):
    ...
    embed.set_author(name="Unslowmode", icon_url="https://cdn.discordapp.com/attachments/1305552495942041670/1453759673026084895/GumballZ_Main.jpg?ex=694e9eb3&is=694d4d33&hm=2551fd70aa2d5aca6fc8db65dafab0635fb4b9f7a8166e56450727e8a3d61d32&")
    embed.set_footer(text=f"Requested by {ctx.author}",
                        icon_url=ctx.author.avatar.url if ctx.author.avatar else ctx.author.default_avatar.url)
    await ctx.send(embed=embed)
  ...
  async def delsticker(self, ctx: commands.Context, *, name=None):
        ...
        try:
            ...
            await ctx.reply(f"<:tick:1453391589148983367>> Sucessfully deleted sticker named `{name}`")
        except:
        ...
        if len(found_emojis) != 0:
            ...
            for emoji_id in found_emojis:
                try:
                    ...
                    continue  
            await init_message.delete()
            return await ctx.reply(f"<:tick:1453391589148983367>> | Successfully deleted {delete_count}/{len(found_emojis)} emoji(s).")
  ...
  async def roleicon(self, ctx: commands.Context, role: discord.Role, *, icon: Union[discord.Emoji, discord.PartialEmoji, str] = None):
    ...
    if role.position >= ctx.guild.me.top_role.position:
        ...
        error_embed.set_author(name="Error", icon_url="https://cdn.discordapp.com/attachments/1305552495942041670/1453759673026084895/GumballZ_Main.jpg?ex=694e9eb3&is=694d4d33&hm=2551fd70aa2d5aca6fc8db65dafab0635fb4b9f7a8166e56450727e8a3d61d32&")
    ...
    if isinstance(icon, discord.Emoji) or isinstance(icon, discord.PartialEmoji):
        ...
        try:
            ...
            await role.edit(display_icon=image_data)
            success_embed = discord.Embed(
                description=f"<:tick:1453391589148983367>>| Successfully changed the icon for {role.mention}.",
                color=self.color
            )
            return await ctx.reply(embed=success_embed, mention_author=False)
        except Exception as e:
      ...
      if interaction.user == ctx.author:
        if interaction.guild.me.guild_permissions.ban_members:
          ...
          async for idk in interaction.guild.bans(limit=None):
            ...
            a += 1
          await interaction.channel.send(
            content=f"<:tick:1453391589148983367>> Successfully Unbanned {a} Members")
        else:
          await interaction.response.edit_message(
            content=
