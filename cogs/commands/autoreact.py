...
class AutoReaction(commands.Cog):
    ...
    async def add(self, ctx, trigger: str, *, emojis: str):
        if len(trigger.split()) > 1:
            embed = discord.Embed(
                title="<:cross:1453391695705280705> Invalid Trigger",
        ...
        if len(emoji_list) > 10:
            embed = discord.Embed(
                title="<:cross:1453391695705280705> Too Many Emojis",
        ...
        if len(triggers) >= 10:
            embed = discord.Embed(
                title="<:icons_warning:1453394993137057939> Trigger Limit Reached",
        ...
        if await self.trigger_exists(ctx.guild.id, trigger):
            embed = discord.Embed(
                title="<:icons_warning:1453394993137057939> Trigger Exists",
        ...
        embed = discord.Embed(
            title="<:tick:1453391589148983367> Trigger Added",
    ...
    async def remove(self, ctx, trigger: str):
        if not await self.trigger_exists(ctx.guild.id, trigger):
            embed = discord.Embed(
                title="<:cross:1453391695705280705> Trigger Not Found",
        ...
        embed = discord.Embed(
            title="<:tick:1453391589148983367> Trigger Removed",
    ...
    async def reset(self, ctx):
        ...
        if not triggers:
            embed = discord.Embed(
                title="<:cross:1453391695705280705> No Triggers Set",
        ...
        embed = discord.Embed(
            title="<:tick:1453391589148983367> All Triggers Reset",
