    ...
    async def extraowner(self, ctx, option: str = None, user: discord.Member = None):
        ...
        if option.lower() == 'set':
            ...
            if view.value is None:
                ...
                await message.edit(content="<:cross:1453391695705280705> Action cancelled.", embed=None, view=None)
            ...
            if not row:
                ...
                if view.value is None:
                    ...
                    await message.edit(content="<:cross:1453391695705280705> Action canceled.", embed=None, view=None)
