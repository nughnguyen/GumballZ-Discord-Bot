...
class Voice(commands.Cog):
    ...
    async def _kick(self, ctx, *, member: discord.Member):
        ...
        embed2 = discord.Embed(title="<:tick:1453391589148983367>> Success",
    ...
    async def _mute(self, ctx, *, member: discord.Member = None):
        if member is None:
            embed = discord.Embed(
                title="<:cross:1453391695705280705> Error",
    ...
    async def vcunmute(self, ctx, *, member: discord.Member):
        ...
        if member.voice.mute == False:
            embed2 = discord.Embed(title="<:cross:1453391695705280705> Error",
            ...
            return await ctx.reply(embed=embed2)
        ch = member.voice.channel.mention
        embed3 = discord.Embed(title="<:tick:1453391589148983367>> Success",
    ...
    async def _moveall(self, ctx, *, channel: discord.VoiceChannel):
        ...
        try:
            ...
            embed3 = discord.Embed(title="<:cross:1453391695705280705> Error",
