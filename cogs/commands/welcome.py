...
class Welcomer(commands.Cog):
    ...
    async def simple_setup(self, ctx):
        ...
        async def submit_callback(interaction):
            ...
            if message_content:
                ...
                await interaction.response.send_message("<:tick:1453391589148983367>> Welcome message setup completed!")
        ...
        cancel_button = Button(emoji="<:icon_plus:1453769872092823623>", style=discord.ButtonStyle.secondary)
    ...
    color=discord.Color(embed_data["color"]) if embed_data["color"] else discord.Color(0x2f3136)
        ...
        async def submit_callback(interaction):
            ...
            await interaction.response.send_message("<:tick:1453391589148983367>> Embed welcome message setup completed!")
    ...
    async def greet_reset(self, ctx):
        ...
        async def yes_button_callback(interaction):
            ...
            embed.title = "<:tick:1453391589148983367>> Success"
    ...
    async def greet_channel(self, ctx):
        ...
        def generate_view(page):
            select_menu = Select(
                ...
                options=[
                    discord.SelectOption(label=channel.name, emoji="<:icon_channel:1453770387199361171>", value=str(channel.id))
            ...
            async def select_callback(interaction: discord.Interaction):
                ...
                await ctx.send(f"<:tick:1453391589148983367>> Welcome channel has been set to {selected_channel.mention}")
    ...
    async def greet_autodelete(self, ctx, time: str):
        ...
        await ctx.send(f"<:tick_green:1453770818952757330> Auto delete duration has been set to **{auto_delete_duration}** seconds.")
