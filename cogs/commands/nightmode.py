...
class Nightmode(commands.Cog):
    ...
    async def enable_nightmode(self, ctx):
        if ctx.guild.member_count < 50:  
            return await ctx.send(embed=discord.Embed(title=" <:cross:1453391695705280705> Access Denied",
                color=self.color,
        ...
        if not own and not (
            ...
            return await ctx.send(embed=discord.Embed(title="<:warning:1453394915491975414> Access Denied",
                color=self.color,
        ...
        if not manageable_roles:
            return await ctx.send(embed=discord.Embed(title="<:cross:1453391695705280705> Error",
                color=self.color,
        ...
        await ctx.send(embed=discord.Embed(title="<:tick:1453391589148983367> Success",
            color=self.color,
