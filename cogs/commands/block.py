...
class Block(commands.Cog):
  ...
  async def add_user(self, ctx, user: discord.User):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if await cursor.fetchone():
        ...
        await db.commit()
        embed = discord.Embed(
          title="<:tick:1453391589148983367> User Blacklisted",
  ...
  async def remove_user(self, ctx, user: discord.User):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if not await cursor.fetchone():
        embed = discord.Embed(
          title="<:cross:1453391695705280705> User Not Blacklisted",
        ...
        await db.commit()
        embed = discord.Embed(
          title="<:tick:1453391589148983367> User Unblacklisted",
  ...
  async def show_users(self, ctx):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if not rows:
        embed = discord.Embed(
          title="<:cross:1453391695705280705> No Blacklisted Users",
  ...
  async def add_guild(self, ctx, guild_id: int):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if await cursor.fetchone():
        embed = discord.Embed(
          title="<:cross:1453391695705280705> Guild Already Blacklisted",
        ...
        await db.commit()
        embed = discord.Embed(
          title="<:tick:1453391589148983367> Guild Blacklisted",
  ...
  async def remove_guild(self, ctx, guild_id: int):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if not await cursor.fetchone():
        embed = discord.Embed(
          title="<:cross:1453391695705280705> Guild Not Blacklisted",
        ...
        await db.commit()
        embed = discord.Embed(
          title="<:tick:1453391589148983367> Guild Unblacklisted",
  ...
  async def show_guilds(self, ctx):
    async with aiosqlite.connect('db/block.db') as db:
      ...
      if not rows:
        embed = discord.Embed(
          title="<:cross:1453391695705280705> No Blacklisted Guilds",
