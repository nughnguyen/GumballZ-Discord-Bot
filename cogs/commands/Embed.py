...
class Embed(commands.Cog):
    ...
    async def _embed(self, ctx):
        ...
        button_send = Button(label="Send Embed",  emoji="<:tick:1453391589148983367>", style=discord.ButtonStyle.success)
        button_send.callback = send_callback

        button_delete = Button(label="Cancel Setup",  emoji="<:cross:1453391695705280705>", style=discord.ButtonStyle.danger)
