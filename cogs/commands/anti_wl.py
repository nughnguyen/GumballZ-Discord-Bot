...
class Whitelist(commands.Cog):
    ...
    async def whitelist(self, ctx, member: discord.Member = None):
        ...
        if not member:
            ...
            embed.add_field(name="__**Usage**__", value=f"<a:ArrowRed:1453413846755578079> `{prefix}whitelist @user/id`\n<a:ArrowRed:1453413846755578079> `{prefix}wl @user`")
            embed.set_thumbnail(url=ctx.bot.user.avatar.url)
            return await ctx.send(embed=embed)
        ...
        embed = discord.Embed(
            ...
            color=0xFF0000,
            description=(
                f"<:Disable:1453394975491494049> : **Ban**\n"
                f"<:Disable:1453394975491494049> : **Kick**\n"
                f"<:Disable:1453394975491494049> : **Prune**\n"
                f"<:Disable:1453394975491494049> : **Bot Add**\n"
                f"<:Disable:1453394975491494049> : **Server Update**\n"
                f"<:Disable:1453394975491494049> : **Member Update**\n"
                f"<:Disable:1453394975491494049> : **Channel Create**\n"
                f"<:Disable:1453394975491494049> : **Channel Delete**\n"
                f"<:Disable:1453394975491494049> : **Channel Update**\n"
                f"<:Disable:1453394975491494049> : **Role Create**\n"
                f"<:Disable:1453394975491494049> : **Role Delete**\n"
                f"<:Disable:1453394975491494049> : **Role Update**\n"
                f"<:Disable:1453394975491494049> : **Mention** @everyone\n"
                f"<:Disable:1453394975491494049> : **Webhook Management**"
        ...
        embed.set_footer(text=f"Developed by GumballZ™")
        ...
        try:
            ...
            if interaction.data["custom_id"] == "catWl":
                ...
                embed = discord.Embed(
                    ...
                    color=0xFF0000,
                    description=(
                         f"<:Enable:1453394983771181108> : **Ban**\n"
                f"<:Enable:1453394983771181108> : **Kick**\n"
                f"<:Enable:1453394983771181108> : **Prune**\n"
                f"<:Enable:1453394983771181108> : **Bot Add**\n"
                f"<:Enable:1453394983771181108> : **Server Update**\n"
                f"<:Enable:1453394983771181108> : **Member Update**\n"
                f"<:Enable:1453394983771181108> : **Channel Create**\n"
                f"<:Enable:1453394983771181108> : **Channel Delete**\n"
                f"<:Enable:1453394983771181108> : **Channel Update**\n"
                f"<:Enable:1453394983771181108> : **Role Create**\n"
                f"<:Enable:1453394983771181108> : **Role Delete**\n"
                f"<:Enable:1453394983771181108> : **Role Update**\n"
                f"<:Enable:1453394983771181108> : **Mention** @everyone\n"
                f"<:Enable:1453394983771181108> : **Webhook Management**"
                    )
                )
                embed.add_field(name="**Executor**", value=f"<@!{ctx.author.id}>", inline=True)
                embed.add_field(name="**Target**", value=f"<@!{member.id}>", inline=True)
                ...
                embed_description = "\n".join(f"<:cross:1453391695705280705><:tick:1453391589148983367>> : **{name}**" for key, name in fields.items())
                ...
                for value in interaction.data["values"]:
                    ...
                    embed_description = embed_description.replace(f"<:Disable:1453394975491494049> : **{fields[value]}**", f"<:Enable:1453394983771181108> : **{fields[value]}**")
