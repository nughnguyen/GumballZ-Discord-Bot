...
class Paginator(discord.ui.View):
    ...
    def update_styles(self, **kwargs):
        ...
        self.first_page_button.emoji = kwargs.get('first_button_emoji') or '<:rewind:1453652995991404584>'
        self.previous_page_button.emoji = kwargs.get(
            'previous_button_emoji') or '<:nextt:1453801427502628906>'
        self.next_page_button.emoji = kwargs.get('next_button_emoji') or '<:icons_next:1453658490248626258>'
        self.last_page_button.emoji = kwargs.get('last_button_emoji') or '<:forward:1453664212768260187>'
        self.stop_button.emoji = kwargs.get(
            'stop_button_emoji') or '<:delete:1453602008786534514>'
